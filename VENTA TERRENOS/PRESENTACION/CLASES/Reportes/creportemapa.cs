   ...
   public  class creportemapa
    {
        ...
        {
            iTextSharp.text.Image img = Image.GetInstance(Application.StartupPath + @"\imagen.jpg");

            iTextSharp.text.Image imglogo = Image.GetInstance(Application.StartupPath + @"\images\logo2.png");

            Document doc = new Document(PageSize.LETTER, 30, 20, 40, 60);
            //'indicamos donde vamos a guardar el documento
            string filename = Application.StartupPath + @"\ReporteReservaMapa.pdf";
            ...
            // 'abrimos el archivo
            doc.Open();
            img.SetAbsolutePosition(60, 111);
            img.ScalePercent(70);
            doc.Add(img);

            imglogo.SetAbsolutePosition(40, 711);
